...
namespace UtmBuilder.Core.ValueObjects
{
    public class Campaign : ValueObject
    {
        ...
        /// <summary>The referrer (e.g. google, newsletter)</summary>
        public string Source { get; }
        /// <summary>Marketing medium (e.g. cpc, banner, email)</summary>
        public string Medium { get; }
        /// <summary>Product, promo code, or slogan</summary>
        public string Name { get; }
        /// <summary>The ads campaign id</summary>
        public string? Id { get; }
        /// <summary>Identify the paid keywords</summary>
        public string? Term { get; }
        /// <summary>Use to differentiate ads</summary>
