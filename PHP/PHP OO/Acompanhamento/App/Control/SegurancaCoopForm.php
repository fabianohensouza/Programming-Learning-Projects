 ...
 */
class SegurancaCoopForm extends Page
{
    ...
    public function __construct()
    {
        ...
        $this->form = new FormWrapper(new Form('form_seguranca_coop'));
        ...
        $this->form->addAction('Avançar', new Action(array("SegurancaForm", 'onEdit')));
