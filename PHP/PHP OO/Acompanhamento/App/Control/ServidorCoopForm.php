 ...
 */
class ServidorCoopForm extends Page
{
    ...
    public function __construct()
    {
        ...
        $this->form = new FormWrapper(new Form('form_servidor_coop'));
        ...
        //$action = new Action("ServidorForm", 'onEdit');
        //$action->setParameter()
        $this->form->addAction('Avançar', new Action(array("ServidoresForm", 'onEdit')));
