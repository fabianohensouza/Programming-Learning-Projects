 ...
 */
class AntivirusCoopForm extends Page
{
    ...
    public function __construct()
    {
        ...
        $this->form = new FormWrapper(new Form('form_antivirus_coop'));
        ...
        $this->form->addAction('Avançar', new Action(array("AntivirusForm", 'onEdit')));
