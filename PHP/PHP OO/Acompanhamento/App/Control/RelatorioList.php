 ...
 * Cadastro de cidades
 */
class RelatorioList extends Page
{
    private $form;
    private $datagrid;
    private $loaded;
    ...
    public function __construct()
    {
        ...
        $this->activeRecord = 'RelatAcpmt';
        
        // instancia um formulário
        $this->form = new FormWrapper(new Form('form_relat_acpmt'));
        $this->form->setTitle('Relatórios de Acompanhamento');
        
        // cria os campos do formulário
        $cooperativas   = new Combo('id_coop');
        $periodos       = new Month('periodo');
        ...
        $this->form->addField('Filtrar por Período', $periodos, '30%');
        
        $this->form->addAction('Buscar', new Action(array($this, 'onReload')));
        $this->form->addAction('Gerar Relatórios', new Action(array("RelatorioForm", 'onReload')));
    ...
    public function onReload()
    {
        ...
        if ($dados->periodo)  $criteria->add('periodo', 'like', "%{$dados->periodo}%");
